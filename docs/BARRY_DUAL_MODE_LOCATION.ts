// Barry Dual-Mode Edge Function with Location Awareness
// Date: 2025-09-27
// Status: DUAL-MODE WITH LOCATION
// Version: 60
// API: OpenAI GPT-4o
// Mode: Full ChatGPT for general + Database-only for Unimog
//
...
serve(async (req) => {
  ...
  try {
    ...
    return new Response(JSON.stringify({
      content: responseContent,  // Changed from 'response' to 'content' to match frontend
