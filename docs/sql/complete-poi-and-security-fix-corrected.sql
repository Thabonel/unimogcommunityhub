-- ========================================
-- COMPLETE POI & SECURITY FIXES (CORRECTED)
...
-- Verify RLS policies (CORRECTED COLUMN NAMES)
SELECT
...
-- Final verification that REST API will work
SELECT
    'POI table is now accessible via REST API' as api_status,
    schemaname,
    tablename,
    tableowner
FROM pg_tables
WHERE tablename = 'pois' AND schemaname = 'public';