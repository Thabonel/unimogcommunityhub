...
- `docs/BARRY_PHASE2_PROD_BACKFILL_STEERING.sql` — 74 documents, 440 evidence units, 1,006 annotations (252 approved, 754 proposed), 199 review items, and the `prod-steering-phase2-1` run record.
