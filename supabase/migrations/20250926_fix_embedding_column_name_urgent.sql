-- URGENT FIX: Barry AI semantic search functions use wrong column name
-- Functions reference 'embeddings' but column is 'embedding' (singular)
-- This causes 500 errors in Edge Function
