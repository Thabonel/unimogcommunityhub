-- Migration: Populate RPS data from extracted manual content
-- Date: October 17, 2025
-- Source: RPS 02155 Unimog GS Base - Pages 251-285
-- Groups: DHA, DHB, DK, EA, EC, ED

BEGIN;

-- Insert Group DHA: Turbocharger, Airesearch
...
-- Insert illustration for Group DHA
...
-- Insert parts for Group DHA (selected examples from page 104)
...
VALUES
  -- Item 014
  (NULL, '5330 12-168-5836', 'DHA', '014', 'GASKET ASBESTOS, TURBOCHARGER', '02155', 1, 'M', 104, 'rps_02155_chunk_003c_pages_0251-0285.pdf', 'DHA-1', '14', 'Mercedes Unimog GS Base', '{"manufacturer_codes": ["D8046/3521B70080", "D8046/3521B70080"], "uoi": "EA"}'::jsonb),

  -- Item 015
  (NULL, NULL, 'DHA', '015', 'OIL LINE', '02155', 1, NULL, 104, 'rps_02155_chunk_003c_pages_0251-0285.pdf', 'DHA-1', '15', 'Mercedes Unimog GS Base', '{"manufacturer_codes": ["D8046/352 180 49 22", "D8046/352 180 49 22"], "uoi": "EA"}'::jsonb),

  -- Item 016
  (NULL, NULL, 'DHA', '016', 'SCREW, M 8 BY 22', '02155', 2, NULL, 104, 'rps_02155_chunk_003c_pages_0251-0285.pdf', 'DHA-1', '16', 'Mercedes Unimog GS Base', '{"manufacturer_codes": ["D8046/000933 008215", "D8046/000933 008215"], "uoi": "EA"}'::jsonb),
...
-- Insert Group DHB: Turbocharger, KKK
INSERT INTO rps_groups (rps_number, group_code, group_name, total_parts, page_start, page_end, chunk_file, metadata)
VALUES (
  '02155',
  'DHB',
...
-- Insert illustration for Group DHB
INSERT INTO rps_illustrations (rps_number, group_code, figure_number, description, page_number, callouts, metadata)
VALUES (
  '02155',
  'DHB',
...
-- Insert parts for Group DHB (selected examples from page 107-108)
INSERT INTO rps_parts (niin, nsn, group_code, item_number, description, rps_number, quantity, repair_grade, page_number, chunk_file, figure_reference, callout, vehicle_model, metadata)
VALUES
  -- Item 011
  ...
  -- Item 004
  (NULL, NULL, 'DHB', '004', 'ELBOW', '02155', 1, NULL, 107, 'rps_02155_chunk_003c_pages_0251-0285.pdf', 'DHB-1', '4', 'Mercedes Unimog GS Base', '{"manufacturer_codes": ["D8046/352 098 63 15", "D8046/352 098 63 15"], "uoi": "EA"}'::jsonb)
ON CONFLICT (niin) DO NOTHING;

-- Insert Group DK: Air Cleaner Assembly, Intake and Connections
INSERT INTO rps_groups (rps_number, group_code, group_name, total_parts, page_start, page_end, chunk_file, metadata)
VALUES (
  '02155',
  'DK',
...
-- Insert illustrations for Group DK
INSERT INTO rps_illustrations (rps_number, group_code, figure_number, description, page_number, callouts, metadata)
VALUES (
  '02155',
  'DK',
...
-- Insert parts for Group DK (selected examples from page 111-113)
INSERT INTO rps_parts (niin, nsn, group_code, item_number, description, rps_number, quantity, repair_grade, page_number, chunk_file, figure_reference, callout, vehicle_model, metadata)
VALUES
  -- Item 001
  (NULL, NULL, 'DK', '001', 'AIR CLEANER ASSEMBLY (INCLUDES DK 002 TO DK 008)', '02155', 1, NULL, 111, 'rps_02155_chunk_003c_pages_0251-0285.pdf', 'DK-1', '1', 'Mercedes Unimog GS Base', '{"manufacturer_codes": ["Z4067/0090940802", "Z4067/0090940802"], "uoi": "EA"}'::jsonb),
...
-- Insert Group EA: Clutch Master Cylinder, Pedal and Bracket
INSERT INTO rps_groups (rps_number, group_code, group_name, total_parts, page_start, page_end, chunk_file, metadata)
VALUES (
  '02155',
  'EA',
...
-- Insert illustration for Group EA
INSERT INTO rps_illustrations (rps_number, group_code, figure_number, description, page_number, callouts, metadata)
VALUES (
  '02155',
  'EA',
...
-- Insert parts for Group EA (selected examples from page 114-118)
INSERT INTO rps_parts (niin, nsn, group_code, item_number, description, rps_number, quantity, repair_grade, page_number, chunk_file, figure_reference, callout, vehicle_model, metadata)
VALUES
  -- Item 002
  ...
  -- Item 9001
  ('12-191-5911', '2540 12-191-5911', 'EA', '9001', 'PAD,PEDAL', '02155', 1, 'L', 115, 'rps_02155_chunk_003c_pages_0251-0285.pdf', 'EA-1', NULL, 'Mercedes Unimog GS Base', '{"manufacturer_codes": ["D8046/1072910182", "D8046/1072910182"], "repair_grade_text": "EA LM", "uoi": "EA"}'::jsonb)
ON CONFLICT (niin) DO NOTHING;

-- Insert Group EC: Clutch Slave Cylinder and Pipes
INSERT INTO rps_groups (rps_number, group_code, group_name, total_parts, page_start, page_end, chunk_file, metadata)
VALUES (
  '02155',
  'EC',
...
-- Insert illustration for Group EC
INSERT INTO rps_illustrations (rps_number, group_code, figure_number, description, page_number, callouts, metadata)
VALUES (
  '02155',
  'EC',
...
-- Insert parts for Group EC (selected examples from page 119-120)
INSERT INTO rps_parts (niin, nsn, group_code, item_number, description, rps_number, quantity, repair_grade, page_number, chunk_file, figure_reference, callout, vehicle_model, metadata)
VALUES
  -- Item 001
...
-- Insert Group ED: Clutch and Housing
INSERT INTO rps_groups (rps_number, group_code, group_name, total_parts, page_start, page_end, chunk_file, metadata)
VALUES (
  '02155',
  'ED',
...
-- Insert illustration for Group ED
INSERT INTO rps_illustrations (rps_number, group_code, figure_number, description, page_number, callouts, metadata)
VALUES (
  '02155',
  'ED',
...
-- Insert parts for Group ED (selected examples from page 121)
INSERT INTO rps_parts (niin, nsn, group_code, item_number, description, rps_number, quantity, repair_grade, page_number, chunk_file, figure_reference, callout, vehicle_model, metadata)
VALUES
  -- Item 001
