-- CRITICAL FIX: Barry AI semantic search functions are broken due to wrong column name
-- Issue: Functions reference 'embeddings' but column is actually 'embedding' (singular)
-- This is the root cause of "Edge Function returned a non-2xx status code" error
