...
const concepts: SemanticConceptDefinition[] = [
  ...
  {
    conceptKey: 'component.load_platform',
    conceptType: 'component',
    canonicalName: 'load platform',
    description: 'Cargo tray, platform body, or fitted load bed',
  },
  {
  ...
  {
    conceptKey: 'property.dimension',
    conceptType: 'property',
    canonicalName: 'dimension',
    description: 'Physical length, width, height, or wheelbase measurement',
  },
  {
...
const aliases: SemanticAliasDefinition[] = [
  ...
  { aliasText: 'u1700', conceptKey: 'vehicle_model.u1700l', aliasType: 'abbreviation', confidence: 0.9 },
  { aliasText: 'u 1700 l', conceptKey: 'vehicle_model.u1700l', aliasType: 'spelling_variant', confidence: 0.95 },
  { aliasText: 'tray', conceptKey: 'component.load_platform', aliasType: 'owner_term', confidence: 0.95 },
  { aliasText: 'truck bed', conceptKey: 'component.load_platform', aliasType: 'owner_term', confidence: 0.9 },
  { aliasText: 'platform body', conceptKey: 'component.load_platform', aliasType: 'workshop_term', confidence: 0.95 },
  { aliasText: 'cargo body', conceptKey: 'component.load_platform', aliasType: 'workshop_term', confidence: 0.9 },
  ...
  { aliasText: 'length', conceptKey: 'property.dimension', aliasType: 'owner_term', confidence: 0.95 },
  { aliasText: 'lenth', conceptKey: 'property.dimension', aliasType: 'common_misspelling', confidence: 0.95 },
  { aliasText: 'width', conceptKey: 'property.dimension', aliasType: 'owner_term', confidence: 0.95 },
  { aliasText: 'height', conceptKey: 'property.dimension', aliasType: 'owner_term', confidence: 0.9 },
  { aliasText: 'dimensions', conceptKey: 'property.dimension', aliasType: 'owner_term', confidence: 0.95 },
  { aliasText: 'measurement', conceptKey: 'property.dimension', aliasType: 'owner_term', confidence: 0.85 },
  { aliasText: 'wheelbase', conceptKey: 'property.dimension', aliasType: 'workshop_term', confidence: 0.95 },
...
const CLAIM_PATTERNS: Array<{ claimClass: BarryClaimClass; patterns: RegExp[] }> = [
  ...
  { claimClass: 'part_number', patterns: [/\bpart (?:number|no)\b/, /\bniin\b/, /\bnsn\b/, /\b(?:repair|seal) kit\b/] },
  ...
  { claimClass: 'specification', patterns: [/\bspec(?:ification)?s?\b/, /\bpressure\b/, /\bclearance\b/, /\bgap\b/, /\bdimensions?\b/, /\blength\b/, /\blenth\b/, /\bwidth\b/, /\bheight\b/, /\bwheelbase\b/, /\bmeasurements?\b/] },
