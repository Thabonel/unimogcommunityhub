...
-- AVATARS BUCKET - Allow authenticated users to upload their own avatars
...
-- PROFILE PHOTOS BUCKET - Allow authenticated users to manage profile photos
...
-- VEHICLE PHOTOS BUCKET - Allow authenticated users to upload vehicle photos
...
-- SITE ASSETS BUCKET - Allow admin uploads, public read
...
-- ARTICLE FILES BUCKET - Allow authenticated uploads, public read
...
-- MANUALS BUCKET - Restricted access (authenticated users only)
