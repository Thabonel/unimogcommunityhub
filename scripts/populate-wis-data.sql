-- Populate WIS Intelligent System with U435 Taxonomy Data
...
('A000 010 12 01', 'Cylinder Head - OM352', 'Cylinder Head', 'engine_systems', 'om352_engine', 38.5, 3250.00, 'Available', ARRAY[1974,1975,1976,1977,1978], '{"torque_spec_nm": 140, "sequence": "Cross pattern, 3 stages: 70Nm, 105Nm, 140Nm"}', ARRAY[]),
('A000 030 00 17', 'Piston Assembly - OM352 (Set of 6)', 'Pistons', 'engine_systems', 'om352_engine', 8.4, 890.00, 'Available', ARRAY[1974,1975,1976,1977,1978], '{"bore_mm": 97.0, "compression_ratio": "17:1"}', ARRAY[]),
...
('A000 070 03 09', 'Camshaft - OM352', 'Valve Train', 'engine_systems', 'om352_engine', 12.5, 1250.00, 'Available', ARRAY[1974,1975,1976,1977,1978], '{"lift_intake_mm": 10.5, "lift_exhaust_mm": 10.0}', ARRAY[]),
('A000 051 01 33', 'Intake Valve - OM352', 'Valves', 'engine_systems', 'om352_engine', 0.165, 45.00, 'Available', ARRAY[1974,1975,1976,1977,1978], '{"diameter_mm": 44.0, "length_mm": 108.5}', ARRAY[]),
('A000 051 02 33', 'Exhaust Valve - OM352', 'Valves', 'engine_systems', 'om352_engine', 0.175, 48.50, 'Available', ARRAY[1974,1975,1976,1977,1978], '{"diameter_mm": 40.0, "length_mm": 108.5}', ARRAY[]),
...
('A000 180 02 09', 'Engine Oil Filter - OM366', 'Oil Filter', 'service_parts', 'filters', 1.1, 32.00, 'Available', ARRAY[1979,1980,1981,1982,1983,1984,1985,1986,1987,1988,1989,1990,1991], '{"thread": "M22 x 1.5"}', ARRAY[]);
...
('A000 030 10 20', 'A000 030 15 84', 'requires', 'Connecting rod requires big end bearing for assembly', 0.9),
('A000 030 25 01', 'A000 030 30 84', 'requires', 'Crankshaft requires main bearing for assembly', 0.9),
('A000 180 01 09', 'W 930/14', 'compatible_with', 'Compatible cross-reference oil filter', 0.8);

-- Verify the import
SELECT 'Taxonomy entries' as table_name, COUNT(*) as count FROM wis_component_taxonomy
UNION ALL
