/**
 * Vehicle Receipt Uploader Component
 * Drag & drop receipt upload with real-time OCR processing
 */
...
import { OCRStatusIndicator, OCRProcessingAnimation } from './OCRStatusIndicator';

interface VehicleReceiptUploaderProps {
  vehicleId: string;
  userId: string;
...
export const VehicleReceiptUploader: React.FC<VehicleReceiptUploaderProps> = ({
  vehicleId,
  userId,
  onUploadComplete,
  onUploadError,
  ...
  async function processFile(upload: UploadProgress, index: number) {
      ...
      <div className="flex flex-col items-center space-y-4">
        ...
        <div className="space-y-2">
          <h3 className="text-lg font-semibold text-foreground">
            {isDragActive ? 'Drop files here' : 'Upload Receipt Photos'}
          </h3>
