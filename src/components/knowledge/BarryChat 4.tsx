...
import { Send, RotateCw, Trash2, AlertCircle } from 'lucide-react';
...
export function BarryChat({ height = "600px", className }: BarryChatProps) {
    ...
    return (
      <div className={cn("flex flex-col", className)} style={{ height }}>
        <Alert className="m-4">
          ...
          <AlertDescription>
            Barry is not properly configured. Please add your OpenAI API key to the environment variables.
          </AlertDescription>
        </Alert>
      </div>
    );
