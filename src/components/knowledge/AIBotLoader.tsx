  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center space-y-4">
        <RefreshCw className="h-8 w-8 text-primary animate-spin mb-2" aria-hidden="true" />
        <p className="text-sm text-muted-foreground">
          <span className="sr-only">Status:</span> Loading Barry...
        </p>
        <p className="text-xs text-muted-foreground max-w-xs text-center">
          Please wait while Barry gets ready. This may take a moment.
        </p>
        <div className="w-48 space-y-2" aria-hidden="true">
